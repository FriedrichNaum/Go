         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 1:
                  ...
                  else if ((0x7000ac6200000000L & l) != 0L)
                  {
                     if (kind > 11)
                        kind = 11;
                  }
               ...
               case 34:
                  ...
                  break;
               case 35:
                  if ((0x800530000000000L & l) != 0L && kind > 21)
                     kind = 21;
                  break;
               case 36:
                  if (curChar == 34)
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 34:
                  ...
                  break;
               case 35:
                  if ((0x2800000028000000L & l) != 0L && kind > 21)
                     kind = 21;
                  break;
               case 37:
...
static final int[] jjnextStates = {
   186, 188, 196, 204, 215, 236, 257, 268, 273, 281, 301, 516, 520, 521, 524, 525, 
   530, 37, 38, 40, 476, 489, 502, 339, 346, 353, 355, 362, 364, 393, 400, 430, 
   432, 439, 446, 272, 174, 177, 27, 87, 88, 27, 89, 27, 84, 85, 27, 80, 
   81, 82, 313, 315, 180, 181, 183, 317, 324, 331, 168, 172, 148, 151, 154, 160, 
   137, 141, 145, 127, 128, 132, 108, 118, 119, 101, 104, 175, 176, 178, 179, 366, 
   378, 379, 389, 402, 415, 416, 426, 448, 460, 461, 471, 526, 529, 531, 532, 538, 
   542, 544, 
};
